...
@EJB
public class MobileDaoJDBC implements IMobileDao {
    private static final Logger LOGGER = LogManager.getLogger(MobileDaoJDBC.class);
    ...
    @Inject
    public MobileDaoJDBC(ConnectionManager connectionManager) {
