...
public class Task1 {
    public static void main(String[] args) {
        ...
        ClassFactory<Person> personFactory = (Object z, Object x, Object y) -> new Person((String) z, (Integer) x, (Gender) y);
        ClassFactory<Animal> animalFactory = (Object z, Object x, Object y) -> new Animal((String) z, (Person) x, (Integer) y);
        //создаем хозяина и животное:
        //Person person1 = new Person("Негр", 50, Gender.MAN);
        //Animal animal1 = new Animal("Йоу", person1, 10);
        Person person1 = personFactory.create("Негр", 50, Gender.MAN);
        Animal animal1 = animalFactory.create("Йоу", person1, 10);
        try {
    ...
    interface ClassFactory<T> {
        T create(Object z, Object x, Object y);//Object...x
    }
}
